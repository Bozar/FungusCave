...
public class FOVDijkstra : MonoBehaviour
{
    ...
    private void UpdateDistanceBoard()
    {
        ...
        foreach (var grid in surround)
        {
            ...
            {
                if (dungeon.CheckBlock(SubObjectTag.Wall, grid))
                {
                    shadowWall.Push(grid);
                }
